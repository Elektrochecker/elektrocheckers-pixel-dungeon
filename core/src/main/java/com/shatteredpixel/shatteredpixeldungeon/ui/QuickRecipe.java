	...
	public static ArrayList<QuickRecipe> getRecipes( int pageIdx ){
		...
		switch (pageIdx){
			...
			case 8:
				...
				return result;
			case 9:
				result.add(new QuickRecipe(new FlameShot.Recipe()));
				result.add(new QuickRecipe(new IceShot.Recipe()));
				result.add(new QuickRecipe(new VenomShot.Recipe()));
				result.add(new QuickRecipe(new VampiricShot.Recipe()));
				...
				result.add(new QuickRecipe(new GreaterTransmutation.Recipe()));
				result.add(null);
				result.add(new QuickRecipe(new InvariantAncientRune.Recipe()));
				return result;
		}
	}
}
