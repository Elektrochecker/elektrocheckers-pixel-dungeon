...
public class Terrain {
	...
	public static final int RUNETABLE		= 32;

	public static final int CUSTOM_DECO_EMPTY = 99; //regular empty tile that can't be overridden, used for custom visuals mainly
