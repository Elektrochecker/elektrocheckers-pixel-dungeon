 ...
 */
 ...
 public class DungeonTileSheet {
	...
	private static final int FLAT_MODDED = xy(1, 17);
	public static final int FLAT_RUNE_TABLE 	= FLAT_MODDED+0;

	private static final int RAISED_MODDED = xy(1, 18);
	public static final int RAISED_RUNE_TABLE		 = RAISED_MODDED+0;
