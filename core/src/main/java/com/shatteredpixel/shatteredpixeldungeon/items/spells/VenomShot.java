...
public class VenomShot extends TargetedSpell {
	
	{
		image = ItemSpriteSheet.VENOM_SHOT;
	...
	public static class Recipe extends com.shatteredpixel.shatteredpixeldungeon.items.Recipe.SimpleRecipe {
		...
		{
			inputs =  new Class[]{Sorrowmoss.Seed.class, ArcaneCatalyst.class};
			inQuantity = new int[]{1, 1};
			
			cost = 2;
			
			output = VenomShot.class;
			outQuantity = 8;
		}
